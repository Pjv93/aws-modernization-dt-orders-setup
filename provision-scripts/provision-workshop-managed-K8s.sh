...
eksctl create cluster --with-oidc --ssh-access --version=1.26 --managed --name workshop-SH-test --tags "Purpose=dynatrace-modernization-workshop" --ssh-public-key ws-default-keypair
